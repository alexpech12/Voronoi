...
//    public void Draw(float sweepLine)
//    {
//        if (mRoot != null)
//        {
//            mRoot.Draw(sweepLine);
...
//    protected float mStartX; public float StartX { get { return mStartX; } }
//    protected float mEndX; public float EndX { get { return mEndX; } }

//    public abstract BeachLineArc GetLeftLeaf();
//    public abstract BeachLineArc GetRightLeaf();
...
//    {
//        List<BeachLineElement> elementList = GetRoot().GetOrderedElementList();
//        int leftIndex = elementList.IndexOf(this) - 1;

//        BeachLineElement leftElement = null;

//        while(leftIndex > 0)
//        {
//            leftElement = elementList[leftIndex--];
//            if(leftElement is BeachLineArc)
//            {
//                return (BeachLineArc)leftElement;
//            }
//        }
//        return null;
//    }

//    public BeachLineEdge GetLeftEdge()
//    {
//        List<BeachLineElement> elementList = GetRoot().GetOrderedElementList();
//        int leftIndex = elementList.IndexOf(this) - 1;
...
//        {
//            leftElement = elementList[leftIndex--];
//            if (leftElement is BeachLineEdge)
//            {
//                return (BeachLineEdge)leftElement;
//            }
//        }
//        return null;
//    }
...
//    {
//        List<BeachLineElement> elementList = GetRoot().GetOrderedElementList();
//        int rightIndex = elementList.IndexOf(this) + 1;

//        BeachLineElement rightElement = null;

//        while (rightIndex < elementList.Count)
//        {
//            rightElement = elementList[rightIndex++];
//            if (rightElement is BeachLineArc)
//            {
//                return (BeachLineArc)rightElement;
//            }
//        }
//        return null;
//    }

//    public BeachLineEdge GetRightEdge()
//    {
//        List<BeachLineElement> elementList = GetRoot().GetOrderedElementList();
//        int rightIndex = elementList.IndexOf(this) + 1;
...
//        {
//            rightElement = elementList[rightIndex++];
//            if (rightElement is BeachLineEdge)
//            {
//                return (BeachLineEdge)rightElement;
//            }
//        }
//        return null;
//    }
...
//    public void ReplaceWith(BeachLineElement newNode)
//    {
//        if(Parent != null)
//        {
...
//    public List<BeachLineElement> GetOrderedElementList()
//    {
//        List<BeachLineElement> elementList = new List<BeachLineElement>();
//        // Get left list
//        if(LeftChild != null)
//        {
//            List<BeachLineElement> leftList = LeftChild.GetOrderedElementList();
//            foreach (BeachLineElement element in leftList)
//            {
//                elementList.Add(element);
//            }
//        }
//        // Add self to the centre, in between left and right branches
//        elementList.Add(this);
//        if(RightChild != null)
//        {
//            List<BeachLineElement> rightList = RightChild.GetOrderedElementList();
//            foreach (BeachLineElement element in rightList)
//            {
//                elementList.Add(element);
//            }
//        }
...
//        edgeToReplace.ReplaceWith(newEdge);
